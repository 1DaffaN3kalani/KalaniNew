...
cl = LINETCR.LINE()
cl.login(token="EoeGj6fFR901qaLfiNPb.5IOHPdbT5t5i0vWWBP3AEW.+U3eGwPj1MDwPLV4NlPQ6SeLCwynAN6p/KbSYo+a/FM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EokmHYRCilqePtlacjA5.mXox1cuPFvb38/0pDKDUvq.XOoQZmrTB2NDg/kgLmC8MvshLrjXAGwUV57D5rDAzVs=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EoAeuRBWtDrmebKyjYJa.O5n1uKVmlX+8igRgkD16/G.2nwg2OEF5DQhwR0D4NlDQLWpDM6HneDpf1xwUcBzEpc=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EomwWRnxUmGjDAHYlgyb.7ogreboVoYrHiCnlcfymYW.URt43FtNVZRAAPNfohZgsxPu64kZ4vtA6xbbHvyp5v0=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EoprBtqh4ZzRe3eZYJX5.PEqC0WCDeTIsrRVKEzh95q.hIvMhNa9fU1D/3ebQu+oGwpn2l95YRSik7nrGS+qH/E=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EosK7z5Q1bhlLPkRhgY1.swhzxcrZHOiFGpxNw1FGmq.zfYdc6P91m7MSLc5HX0zm72NHcEzrr1Ora/mHS4LRdA=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="Eoso3rdRa5FwZN1ZaDNd.Ua1UarJJVKj4PeFsWZQAFq.Lnr1RFZxybz9MTUPAOP0EuVqK8HS8ueSe+NA0nY/9WE=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="Eop3APndzjdepYxsKrWd.Kas/9mXMmlXxyFSIVLp3Bq.jRoTMJ0ILKqzFxFzDFMDafyaf/c0UtjGtkpmJ1Os6aE=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EoRKTINAhdLJ9VBKEgu0.vzHXWTw/TfIp9pcy1VF60a.r7AahhDJyzIkSti1sIEOezUc5yTDFwhNgj7z4VZiT1I=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token="EoDyfCfiFaqAuhlhNfq7.uuOk7FhZPS80favq6+PjzW.TaByQI0lv89wjPZujxzZub4K23NnvAMqI0pmp5fWVNA=")
ki9.loginResult()

k1 = LINETCR.LINE()
k1.login(token="EoSk7gkWcD3tFPg7AXpd.z33wg5UIjCdhFQWVBPKxpq.saZe2YqjsZfqhSLZJeABDnitV3HR2AHpquPt5UoyMHw=")
k1.loginResult()

k2 = LINETCR.LINE()
k2.login(token="EoSYpLyQvKDiarlOx1Uc.CRC52EKj9eH2WDZHOzA1Ba.ngCcce4vpY10Qx26hafkpJOLv81q7G1Xc51sKoaX6ws=")
k2.loginResult()

k3 = LINETCR.LINE()
k3.login(token="EoT4gvW06UGZsXf3ERld./bB+MjFYDqOYNFxsh1Nk+q.pFEhJL3jDeJpU29fUxH1kz1g5crL1ujnoCVWPmCuaVk=")
k3.loginResult()

k4 = LINETCR.LINE()
k4.login(token="EouxtmCsMbtKGk0ZYCQ4.h7sJc2c857xv4rpLOqLODa.NH3c+Xe000K+uAIQ/MVt6j5Fb6WkHnD5Z0s9uUS4lTs=")
k4.loginResult()

k5 = LINETCR.LINE()
k5.login(token="EoVViBLzgI4qetGEqDb9.0Nwaz4KkX+ThNHAnpGtmcq.fKMyYJ+KrAf9Js7MyoYlxROtfPl6lMWgkUfcUGtYfYk=")
k5.loginResult()

k6 = LINETCR.LINE()
k6.login(token="EozJj8ZhZXDccy4qOyt0.Bf/+wBpJGm1SwJZGVCSIKa.hwXHpMm7rwpAnnTQTRwSnFgYWJGM+g5SHsn3qewHEMI=")
k6.loginResult()

k7 = LINETCR.LINE()
k7.login(token="EoagOUJMumDw2muqpFDe.HFpZxQ4oeE0li18GaPRTlG.7vsSkFg3EUMqneRvCe6bgSO2JNAeV3opM81tjcWxvEQ=")
k7.loginResult()

k8 = LINETCR.LINE()
k8.login(token="Eo9dZ8cCQfcXPL9K0B54.J3fnns0b9SZ+G/AzqKmoza.qcZqSJPioAg0zYXU1mDPjyiBvfSJRRZZFScCxhljm54=")
k8.loginResult()

k9 = LINETCR.LINE()
k9.login(token="EoBS34WH1Yd0gX9Q4Ux8.YsDKcjveIIMRSIJDWy5KIa.Herz0RndIXRgEEh34rKOBcoh9m2YthF5W+jE0pXRNgA=")
k9.loginResult()

w1 = LINETCR.LINE()
w1.login(token="EohJyuAb6Vh3vFeSQrVd.WjEOUssPHrr7ONtR/sUQ+q.emJ3ElUMtkoWn9m0EfKy01ATQ7XLmWg7yW5YBuMjCtg=")
w1.loginResult()

w2 = LINETCR.LINE()
w2.login(token="EozzVpVzBYVmSV7GedRa.BZAx2RzUiLpuPwHqtp9CEG.dVe11iaIiDn19E7muqPAZvX1SNzyvA0EKs/Hx1Tq2UQ=")
w2.loginResult()

w3 = LINETCR.LINE()
w3.login(token="Eoq2wJj3hSBZauOqtr5f.XOhsQp+gksrOUahmNeefNW.QmZ9AREvM/EOPC10kcfe1hND7tj+LgQ4HDKVZwHE+rg=")
w3.loginResult()
...
||======= FOR ADMIN =======||
  ...
  Http://line.me/ti/p/~rozikeane
                    ...
                    ATTENTION!!!!
  TEAM HACK BOT ANDROMEDA :V
"""
helo=""

KAC=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,k1,k2,k3,k4,k5,k6,k7,k8,k9,w1,w2,w3]
...
w3mid = w3.getProfile().mid
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,k1mid,k2mid,k3mid,k4mid,k5mid,k6mid,k7mid,k8mid,k9mid,w1mid,w2mid,w3mid,"ue62a21a4306de53e48d15c306e9dda7b"]
admsa = "ue62a21a4306de53e48d15c306e9dda7b"
admin = "ue62a21a4306de53e48d15c306e9dda7b"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ue62a21a4306de53e48d15c306e9dda7b":
                    if "join:" in msg.text:
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    k5.updateProfile(profile)
                    k5.sendText(msg.to,"􀜁??􏿿Update Names👉" + string + "👈")
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [☸]➦Powered By: Rozikin々•┅─────" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
                           ...
                           for target in targets:                            
                             if not target in Bots:
                                if not target in admin:
                                  try:
                                      klist=[cl,ki,ki2,ki3,ki4,ki5ki6,ki7,ki8,ki9,w1,w2]
                                      kicker=random.choice(klist)
                                      kicker.kickoutFromGroup(msg.to,[target])
                                      print (msg.to,[g.mid])
                                  except:
                                      cl.sendText(msg.to,"Sukses Bosqu")
                                      cl.sendText(msg.to,"Harus habis Bosqu")
              ...
              if msg.from_ in admin:
                ...
                start = time.time()
                cl.sendText(msg.to, "Mohon Bersabar Sejenak Bos...")
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                klist=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,w1,w2]
                                kicker=random.choice(klist)
                                kicker.kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
...
#-----------------------------------------------
            elif msg.text in ["Sayang","Mlebu","All join","Minna"]:
...
#-----------------------------------------------
                        ...
                        w2.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["See you","Dadah","Good bye","Metu"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
